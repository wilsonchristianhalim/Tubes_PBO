...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2021 at 03:36 AM
...
INSERT INTO `news` (`ID_News`, `Title_News`, `Content_News`, `Date_News`) VALUES
(1, 'Valorant New Agent Update', 'Valorant mengeluarkan Agent terbarunya yaitu Agent Chamber. Agent ini termasuk\r\nAgent yang cukup menarik karena dengan skill - skill yang dimilikinya ia dapat\r\nmelakukan kill dengan mudah dan dapat mengetahui posisi musuh.', '2021-11-18'),
(2, 'PUBG Mengadakan Event Black Friday', 'Di kesempatan ini PUBG mengadakan event Black Friday dengan \r\nmeluncurkan Battle Pass terbarunya dengan hadiah - hadiah yang \r\ncukup menarik. Battle Pass kali ini dijual dengan harga yang \r\nlebih murah.', '2021-11-26');
...
INSERT INTO `user` (`Username`, `PW_User`, `Name`, `Email`, `Age`, `tipePerson`) VALUES
('darrel', 'darrel321', 'Darrel', 'darrel.nihboss@yahoo.com', 19, 1),
('tes', 'tes', 'tes', 'tes@gmail.com', 12, 0),
('tes2', 'tes', 'tes2', 'tes2', 16, 0),
('wilson', 'wilson123', 'Wilson', 'wilson.christianhalim@yahoo.com', 19, 1);
...
--
ALTER TABLE `news`
  MODIFY `ID_News` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
